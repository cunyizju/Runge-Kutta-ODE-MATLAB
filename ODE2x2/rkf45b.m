function [u]=rkf45b(neqn,t0,tf,u0,nsteps,abserr,relerr) 
% % Function rkf45b computes an ODE solution by the variable 
% step RK Fehlberg 45 method for a series of points along 
% the solution by repeatedly calling function ssrkf45 for 
%asingle RK Fehlberg 45 step. The truncation error is
...
if nfin1 == 1 
    ...
    for i=1:neqn 
        if abs(e(i)) > (abs(u(i))*relerr+abserr)/32.0
